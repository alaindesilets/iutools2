...
tooling under `data/grammar/fst/`, and the model is a set of `.py` scripts plus a
...
From `data/grammar/fst/`, with `lexicon-analyser.hfstol` built (see `README.md`):
